...
void calculateTimeOffset(int init_hour, int init_minute, int init_second) {
  ...
  offset = (current_minute * 60 + init_second) * 1000;
}
...
void getPhoneTime() { //Skal lige laves
  //skal sætte dems om hedder compileHour og compileMinute
  // Skal i hvert fald bare sætte compileSecond
}